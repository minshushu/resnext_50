...
def get_args():
    ...
    parser.add_argument('--path', type=str, default='/home/project/HuBMAP/lesson1/code/working/data', help='path of csv file with DNA sequences and labels')
...
os.system(f'mkdir /home/project/HuBMAP/lesson1/code/working/input/ckpt-frank/{opts.model_name}')
os.system(f'mkdir /home/project/HuBMAP/lesson1/code/working/logs/{opts.model_name}')
...
#some more things 
logger=CSVLogger_my(['epoch','train_loss','val_loss','dice_coef'], f"/home/project/HuBMAP/lesson1/code/working/logs/{opts.model_name}/log_fold{opts.fold}.csv")
...
for epoch in range(opts.epochs):
    ...
    if metric_this_epoch>best_metric:
        torch.save(model.state_dict(),f'/home/project/HuBMAP/lesson1/code/working/input/ckpt-frank/{opts.model_name}/fold{opts.fold}.pth')
